...
def upload_video():
    ...
    result = cv2.VideoWriter('static/', 'blackNwhite.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, size, 0)
...
@app.route('/download')
def download_file():
    converted_video_path = "static/blacknwhite.mp4"
